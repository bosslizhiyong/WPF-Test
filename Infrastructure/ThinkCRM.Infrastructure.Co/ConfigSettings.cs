...
namespace ThinkCRM.Infrastructure.Co
{
    public class ConfigSettings
    {
        ...
        /// 版本检查时间间隔
        /// </summary>
        public static int VersionInterval { get; set; }
        /// <summary>
        /// 有效期检查时间间隔
        /// </summary>
        public static int AvailabilityInterval { get; set; }
        /// <summary>
        /// 当前路径
        /// </summary>
        ...
        public static void Initialize()
        {
            ...
            //版本检查时间间隔
            settingValue = ConfigurationManager.AppSettings["VersionInterval"];
            VersionInterval = !string.IsNullOrEmpty(settingValue) ? DataTypeConvert.ToInt32(settingValue) : 1800000;
            //有效期检查时间间隔
            settingValue = ConfigurationManager.AppSettings["AvailabilityInterval"];
            AvailabilityInterval = !string.IsNullOrEmpty(settingValue) ? DataTypeConvert.ToInt32(settingValue) : 28800000;
            //当前路径
            ...
            //版本文件的总目录
            settingValue = ConfigurationManager.AppSettings["VersionFilePath"];
            VersionFilePath = !string.IsNullOrEmpty(settingValue) ? settingValue : "/VersionFiles/";
