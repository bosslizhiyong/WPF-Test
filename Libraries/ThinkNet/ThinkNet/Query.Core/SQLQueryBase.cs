...
namespace ThinkNet.Query.Core
{
        ...
        where T : DataEntityBase, new()
    {
        ...
        public SQLQueryBase(string connectionStringName,IDAOCenter daoCenter)
        {
            this._connectionStringName = connectionStringName;
            this._daoCenter = daoCenter;
            //_mTargetDAO.IsExternalConnection = true;
            //_mTargetDAO.ExternalConnectionStringsName = connectionStringName;
        }
        ...
        /// <returns></returns>
        public virtual T GetSingleObject(QueryParamater queryParamater)
        {
            _mTargetDAO = CreateDAO();
            ...
            List<T> collections = _mTargetDAO.GetList(mPager);
        ...
        /// <returns></returns>
        public virtual PageResult<T> GetPagerList(QueryParamater queryParamater, int pageIndex, int pageSize)
        {
            _mTargetDAO = CreateDAO();
            ...
            List<T> collections = _mTargetDAO.GetList(mPager);
            int totalRecord = _mTargetDAO.GetCount(queryParamater.Where);
        ...
        /// <param name="queryParamater">查询参数</param>
        /// <returns></returns>
        public virtual IEnumerable<T> GetList(QueryParamater queryParamater)
        {
            _mTargetDAO = CreateDAO();
            Pager mPager = new Pager(queryParamater.Where, 1, int.MaxValue, queryParamater.OrderType, queryParamater.Columns, queryParamater.OrderField, queryParamater.TableName);
            List<T> collections = _mTargetDAO.GetList(mPager);
        ...
        /// <param name="pageSize">每页记录数</param>
        /// <returns></returns>
        public virtual PageResult<DataRow> GetPagerTable(QueryParamater queryParamater, int pageIndex, int pageSize)
        {
            _mTargetDAO = CreateDAO();
            Pager mPager = new Pager(queryParamater.Where, pageIndex, pageSize, queryParamater.OrderType, queryParamater.Columns, queryParamater.OrderField, queryParamater.TableName);
            DataTable collections = _mTargetDAO.GetDataTable(mPager);
            int totalRecord = _mTargetDAO.GetCount(queryParamater.Where);
        ...
        /// <param name="queryParamater">查询参数</param>
        /// <returns></returns>
        public virtual IEnumerable<DataRow> GetTable(QueryParamater queryParamater)
        {
            _mTargetDAO = CreateDAO();
            Pager mPager = new Pager(queryParamater.Where, 1, int.MaxValue, queryParamater.OrderType, queryParamater.Columns, queryParamater.OrderField, queryParamater.TableName);
            DataTable collections = _mTargetDAO.GetDataTable(mPager);
        ...
        /// <param name="queryParamater">查询参数</param>
        /// <returns></returns>
        public virtual int GetCount(QueryParamater queryParamater)
        {
            _mTargetDAO = CreateDAO();
            return _mTargetDAO.GetCount(queryParamater.Where);
        }
        /// <summary>
        /// 是否存在
        /// </summary>
        /// <param name="queryParamater">查询参数</param>
        /// <returns></returns>
        public virtual bool Exists(QueryParamater queryParamater)
        {
            _mTargetDAO = CreateDAO();
            return _mTargetDAO.Exists(queryParamater.Where);
        }
        /// <summary>
        /// 获取下一个序号
        /// </summary>
        ...
        /// <returns></returns>
        public virtual int GetNextSequence(int parentId)
        {
            _mTargetDAO = CreateDAO();
        ...
        public virtual int GetNextSequence(string where)
        {
            _mTargetDAO = CreateDAO();
